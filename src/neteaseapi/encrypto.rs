use crate::neteaseapi::encrypto::AesMode::{cbc, ecb};
...
impl Crypto {
    ...
    pub fn weapi(text: &str) -> Vec<(String, String)> {
        println!("text={}", text);
...
mod tests {
    ...
    use super::Crypto;
    use crate::neteaseapi::encrypto::{AesMode, HashType, IV, PRESET_KEY, RSA_PUBLIC_KEY};
    use urlqstring::QueryParams;
